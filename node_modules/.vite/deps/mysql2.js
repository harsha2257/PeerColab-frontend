...
var require_lib2 = __commonJS({
  "node_modules/sql-escaper/lib/index.js"(exports) {
    ...
    var format = (sql, values, stringifyObjects, timezone) => {
...
var require_caching_sha2_password = __commonJS({
  "node_modules/mysql2/lib/auth_plugins/caching_sha2_password.js"(exports, module) {
    ...
    var pluginFactory = (pluginOptions = {}) => ({ connection }) => {
      let state = 0;
      let scramble = null;
      const password = connection.config.password;
      const authWithKey = (serverKey) => {
...
// browser-external:node:diagnostics_channel
var require_node_diagnostics_channel = __commonJS({
  "browser-external:node:diagnostics_channel"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:diagnostics_channel" has been externalized for browser compatibility. Cannot access "node:diagnostics_channel.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_tracing = __commonJS({
  "node_modules/mysql2/lib/tracing.js"(exports, module) {
    "use strict";
    var process2 = require_process();
    var dc = (() => {
      try {
        return "getBuiltinModule" in process2 ? process2.getBuiltinModule("node:diagnostics_channel") : require_node_diagnostics_channel();
      } catch {
        return void 0;
      }
    })();
    var hasTracingChannel = typeof (dc == null ? void 0 : dc.tracingChannel) === "function";
    ...
    function shouldTrace(channel) {
      ...
      return channel.hasSubscribers ?? ((_a = channel.start) == null ? void 0 : _a.hasSubscribers) ?? false;
    }
